    ...
    >
      <nav className="max-w-xl mx-auto flex items-center justify-between h-12 px-4 rounded-3xl shadow-sm backdrop-blur-lg backdrop-saturate-150 bg-black/[.65]">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a
            href="/servicios"
            className="text-sm text-white uppercase tracking-wider hover:text-gray-300 transition-colors"
          >
            Servicios
          </a>
          <a
        ...
        <div
          className={`absolute top-full left-0 right-0 mt-2 md:hidden backdrop-blur-lg backdrop-saturate-150 bg-black/[.65] rounded-2xl transition-all duration-500 ease-in-out ${
            isMenuOpen
